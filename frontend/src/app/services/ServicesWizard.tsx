...
export function ServicesWizard({ producers }: Props) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {producers.map((prod) => (
                    <button
                      ...
                      `}
                    >
                      <div className="w-20 h-20 rounded-full bg-saint-navy flex items-center justify-center mb-2 overflow-hidden relative">
                        {prod.image_url ? (
                          <Image src={prod.image_url} alt={prod.name} fill sizes="80px" className="object-cover" />
                        ) : (
